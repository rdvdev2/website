<template>
  <div class="bg-gray-600 p-4 rounded-2xl flex gap-4 flex-wrap justify-center items-center w-fit">
    ...
    <p class="text-justify max-w-prose">
      ...
      <b>Vulkan</b>, <b>HTML</b> or <b>Python</b>, I feel really comfortable with <b>Java</b> and <b>Rust</b>, and I try
      to develop my projects on those platforms. If I'm known for something, it is for my Minecraft mods, and thus I try
      to put a big effort on them and create quality content for the players. On this web page, you will find all sort
